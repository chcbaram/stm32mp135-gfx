...
static const gpio_tbl_t gpio_tbl[GPIO_MAX_CH] =
    {
      {GPIO_HW, GPIOI, GPIO_PIN_0 ,  _DEF_INPUT , GPIO_PIN_SET, GPIO_PIN_RESET,   _DEF_HIGH, NAME_DEF(SD_DETECT)    },  
      {GPIO_HW, GPIOH, GPIO_PIN_4 ,  _DEF_OUTPUT, GPIO_PIN_SET, GPIO_PIN_RESET,   _DEF_HIGH, NAME_DEF(LCD_TP_RESET) },  
      {GPIO_HW, GPIOI, GPIO_PIN_2 ,  _DEF_INPUT , GPIO_PIN_SET, GPIO_PIN_RESET,   _DEF_HIGH, NAME_DEF(LCD_TP_INT)   },     
      {GPIO_HW, GPIOA, GPIO_PIN_11,  _DEF_OUTPUT, GPIO_PIN_SET, GPIO_PIN_RESET,   _DEF_LOW , NAME_DEF(LCD_BLK)      },   
      {GPIO_HW, GPIOI, GPIO_PIN_7 ,  _DEF_OUTPUT, GPIO_PIN_SET, GPIO_PIN_RESET,   _DEF_HIGH, NAME_DEF(LCD_RESET)    },  
      {GPIO_HW, GPIOH, GPIO_PIN_5 ,  _DEF_OUTPUT, GPIO_PIN_SET, GPIO_PIN_RESET,   _DEF_HIGH, NAME_DEF(LCD_SPI_CS)   },  
      {GPIO_HW, GPIOA, GPIO_PIN_6 ,  _DEF_OUTPUT, GPIO_PIN_SET, GPIO_PIN_RESET,   _DEF_HIGH, NAME_DEF(I2S1_MUTE)    },  
    };
